...
class BaseGraph(Graph):
    ...
    def update_graph_structure(self, relation, from_collections, to_collections, create_collections=True, waitForSync = True):
        """
